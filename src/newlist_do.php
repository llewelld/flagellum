...
if ($user_type === "admin") {
	...
	$sql = $conn->prepare("INSERT INTO Lists (list_date, list_title, list_body, list_keywords, list_comments) VALUES (:list_date, :list_title, :list_body, :list_keywords, :list_comments, :list_comments_id)");
	...
	$sql->bindParam(':list_comments', 0);
	$sql->bindParam(':list_comments_id', "";
	$sql->execute();
