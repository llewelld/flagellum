...
function startmove () {
  ...
  for (i = 0; i < glows; i++) {
    ftype = i % ftypes;
    inject += '<div id="glow'+i+'" class="animate" style="left:0px;top:0px;width:' + fxysize[ftype] + 'px;height:' + fxysize[ftype] + 'px;opacity:0.0;filter:alpha(opacity=0)"><img id="glowi'+i+'" src="./images/animate/glow/' + fname[ftype] + '" width="' + fxysize[ftype] + '" height="' + fxysize[ftype] + '"></div>\n';
  }
