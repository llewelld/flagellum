...
function updateline (line) {
  ...
  line.count++;
  line.direction += (1.6 * (line.name + 1) * Math.sin (line.count / (line.name + 1))) + (7 * Math.cos (line.count / (1.2 * (linestructs - line.name))));
  ...
  name = "f" + line.name;
  document.getElementById (name).style.left = (line.xpos - 20) + "px";
  document.getElementById (name).style.top = (line.ypos - 20) + "px";
