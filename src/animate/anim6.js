...
function startmove () {
  ...
  inject = "";
  for (i = 0; i < glows; i++) {
    inject += '<div id="glow' + i + '" class="animate" style="left:-100px;top:-100px;width:32px;height:32px;opacity:1.0;filter:alpha(opacity=100);border:0;padding:0;margin:0;"><img id="glowi' + i + '" src="./animate/spangle/spangle01.png" width="32" height="32" border="0" style="position:absolute;left:0px;top:0px;border:0;padding:0;margin:0;" /></div>\n';
  }
...
function insertglows() {
  ...
  for (i = 0; i < 9; i++) {
    ...
    imageanim[i].src = "./images/animate/spangle/spangle02-0" + i + "0.png";
  }
